...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
            ...
            // Добавляем lighbox.js
            $this->document->addScript('catalog/view/javascript/lightbox/lightbox.js');
            // Добавляем images.js
            $this->document->addScript('catalog/view/javascript/images.js');
            
			$this->document->addStyle('catalog/view/javascript/jquery/colorbox/colorbox.css');
            $this->document->addStyle('catalog/view/javascript/lightbox/lightbox.css');
